...
#define STRING_CONFIG_H_AUTHOR "Hugo's UM2" // Who made the changes.
#endif
...
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.0,80.0,200,805.68}  // default steps per unit for ultimaker2
#endif
